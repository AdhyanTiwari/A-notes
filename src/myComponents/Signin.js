...
function Signin() {
  ...
  return (
    <form className='container border rounded' onSubmit={onClick} style={{ width: "40%", padding: "1rem" }}>
      ...
      <div className='container mt-3' style={{ width: "90%", paddingTop: "1rem" }} >
        <div className="mb-3">
          ...
          <input type="email" onChange={onChange} className="form-control" id="exampleFormControlInput1" name='email' value={note.email} required />
        </div>
        <div className="mb-3">
